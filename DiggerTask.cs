...
/*
 * Материалы:
 * Практика «Земля и Диггер» // Ulearn.me URL: https://ulearn.me/course/basicprogramming/Praktika_Zemlya_i_Digger__b4fba55d-b35d-4366-b3e3-e1d7f53268b1 (дата обращения: 01.12.2022).
 * 
 * Digger // Википедия URL: https://ru.wikipedia.org/wiki/Digger (дата обращения: 01.12.2022).
 * Земля и Диггер // CyberForum.ru URL: https://www.cyberforum.ru/csharp-beginners/thread2381975.html (дата обращения: 01.12.2022).
 * Control.KeyPress Event // Microsoft URL: https://learn.microsoft.com/en-Us/dotnet/api/system.windows.forms.control.keypress?view=windowsdesktop-7.0&viewFallbackFrom=netcore-3.0 (дата обращения: 01.12.2022).
 */